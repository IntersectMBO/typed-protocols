...
The Cardano open source project `typed-protocols` is committed to ensuring the
security of its software and the privacy of its users. We value the
contributions of the security community in helping us identify and address
vulnerabilities in our code. This Security Vulnerability Disclosure Policy
outlines how security vulnerabilities should be reported and how we will
respond to and remediate such reports.
...
on the [typed-protocols](https://github.com/IntersectMBO/typed-protocols).

## Conclusion

The typed-protocols project greatly appreciates the assistance of the security
